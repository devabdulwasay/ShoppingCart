    ...
    <section class="men-collection gray-bg">
      <div class="container">
        ...
        <div class="owl-carousel owl-theme products-slider">
          <!-- item-->
          <?php  
            while($fetch = mysqli_fetch_array($products))
            {
          ?>
          <div class="item">
            <div class="product is-gray">
              <div class="image d-flex align-items-center justify-content-center"><img src="./img/hoodie-man-1.png" alt="product" class="img-fluid">
                <div class="hover-overlay d-flex align-items-center justify-content-center">
                  <div class="CTA d-flex align-items-center justify-content-center"><a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a><a href="detail.php?id=<?php echo $fetch['id']?>" class="visit-product active"><i class="icon-search"></i>View</a><a href="#" data-toggle="modal" data-target="#exampleModal" class="quick-view"><i class="fa fa-arrows-alt"></i></a></div>
                </div>
              </div>
              <div class="title"><a href="detail.html">
                  <h3 class="h6 text-uppercase no-margin-bottom"><?php echo $fetch['name']?></h3></a><span class="price text-muted">$<?php echo $fetch['price']?></span></div>
            </div>
          </div>
          <?php
            }
