        ...
        <div class="row">
          <div class="col-lg-8">
            <ul class="nav nav-pills">
              <li class="nav-item"><a href="checkout.php" class="nav-link active">Address</a></li>
              ...
              <div id="address" class="active tab-block">
                <form action="#" method="POST">
                  ...
                  <div class="row">
                    <div class="form-group col-md-6">
                      ...
                      <input id="name" type="text" name="name" placeholder="Enter you name" class="form-control" value="<?php 
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input id="email" type="email" name="email" placeholder="enter your email address" class="form-control"value="<?php 
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input id="contact" type="tel" name="contact" placeholder="Your phone number" class="form-control">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="Address" class="form-label">Address</label>
                      <input id="address" type="text" name="Address" placeholder="Your Address" class="form-control">
                    </div>
                  ...
                  <!-- /Shipping Address-->
                  <div class="CTAs d-flex justify-content-between flex-column flex-lg-row"><a href="cart.php" class="btn btn-template-outlined wide prev"> <i class="fa fa-angle-left"></i>Back to basket</a>
                  <button type="submit" name="insert">Choose Payment Method<i class="fa fa-angle-right"></i>
                  </button></div>
                </form>
                ...
                <?php
                  if(isset($_POST['insert']))
                  {
                    ...
                    $sql_query = "INSERT INTO checkout(`name`,`email`,`contact`,`address`) VALUES ('$name','$email','$contact','$address')";
                    ...
                    if($query)
                    {
                      ...
                      foreach($_SESSION['cart'] as $cart)
                      {
                        ...
                        $orderq = "INSERT INTO orders (product_id,order_no,user_id,quantity,amount) VALUES ('$p_id','$order_no','$user_id','$quantity','$amount')";
                        $o_q = mysqli_query($con,$orderq);
                      }
                      header('location:checkout3.php?order-no='.$order_no);
                    }
                    else{
