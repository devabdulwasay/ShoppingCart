                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-users"></i><span class="panel-title">categories</span>
                            ...
                            <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><img src="uploads/<?php echo $category['image']?>" alt="category-image" height='50px'></td>
                                        <td><?php echo $category['p_id']?></td>
                                        <td><?php echo $category['name']?></td>
                                        <td><?php echo $category['status']==1 ? 'Active' : 'InActive'?></td>
                                        <td><a href="add-category.php?id=<?php echo $category['id']?>">Edit</a> | <a class='delete' href='#exampleModal' data-toggle="modal" data-href="categories.php?id=<?php echo $category['id']?>"">Delete</a></td>
                                    </tr>
                                    <?php 
                                        }
                                    ?>
