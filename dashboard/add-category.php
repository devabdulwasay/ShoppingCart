<?php
    ...
    $categories = mysqli_query($con,'select * from categories where parent_id = 0');
    if(isset($_GET['id']))
    {
        $id = $_GET['id'];
                        ...
                        <div class="panel">
                            ...
                            <form method="post" action="" id="admin-form"  enctype='multipart/form-data'>
                                <div class="panel-body">
                                    ...
                                    <div class="section-divider mb40 mt20"><span> Add Role </span>
                                    </div><!-- .section-divider -->
                                        ...
                                        <div class="col-md-12">
                                            <select name="parent_category" id="" class="form-control">
                                                ...
                                                <?php
                                                    if(isset($fetch))
                                                    {
                                                        echo $fetch['parent_id'] == $category['id'] ? 'selected' : null;
                                                    }
                                    ...
                                    <div class="col-md-12">
                                        <select name="status" id="" class="form-control">
                                            <option value="1" <?php if(isset($fetch)){echo $fetch['status']== 1 ? 'selected' : null ;}?>>Active</option>
                                            <option value="0" <?php if(isset($fetch)){echo $fetch['status']== 0 ? 'selected' : null ;}?>>InActive</option>
                                        </select>
                                    </div>
                                </div><!-- end section -->
                            ...
                            <?php
                                if(isset($_POST['submit']))
                                {
                                    ...
                                    {
                                        // update
                                        $update = "UPDATE categories SET p_id = '$parent_category',name = '$name', image = '$image', status = '$status' where id = '$id'";
                                        $sql = mysqli_query($con,$update);
                                    }
                                    else
                                    {
                                        $insert = "INSERT INTO categories(p_id,name,image,status) VALUES ('$parent_category','$name','$image','$status')";
