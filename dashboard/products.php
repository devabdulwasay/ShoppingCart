                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-users"></i><span class="panel-title">Products</span>
                            ...
                            <table class="table table-striped table-hover table-responsive" id="datatable2" cellspacing="0" width="100%">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><img src="uploads/<?php echo $product['image']?>" height="50px"></td>
                                        ...
                                        <td><a href="add-product.php?id=<?php echo$product['id']?>">Edit</a> | <a class='delete' href='#exampleModal' data-toggle="modal" data-href="products.php?id=<?php echo$product['id']?>"">Delete</a></td>
                                    </tr>
                                <?php
                                    }
                                ?>
