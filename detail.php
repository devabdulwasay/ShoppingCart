<?php
  ...
  $products = mysqli_query($con,"select * from products where id = ".$_GET['id']."");
        ...
        <div class="row">
          <div class="product-images col-lg-6">
            ...
            <div data-slider-id="1" class="owl-carousel items-slider owl-drag">
              <div class="item"><img src="img/shirt.png" alt="shirt"></div>
          ...
          <div class="details col-lg-6">
            <div class="d-flex align-items-center justify-content-between flex-column flex-sm-row">
              <ul class="price list-inline no-margin">
                <li class="list-inline-item current">$<?php echo $product['price']?></li>
            ...
            <div class="d-flex align-items-center justify-content-center justify-content-lg-start">
              <div class="quantity d-flex align-items-center">
                ...
                <input type="text" value="1" name='quantity' class="quantity-no">
            ...
            <ul class="CTAs list-inline">
              ...
              <input type="hidden" name="image" value='<?php echo $product['image']?>'>
                ...
                <button type='submit' name='cart' href="#" class="btn btn-template wide"> <i class="icon-cart"></i>Add to Cart</button></li>
              </form>

              <li class="list-inline-item">
              <a href="#" class="btn btn-template-outlined wide"> <i class="fa fa-heart-o"></i>Add to wishlist</a></li>
            </ul>
          </div>
        </div>
      </div>
            ...
            <div class="row">
              <div class="col-xl-9">
                <div class="row review">
                  <div class="col-3 text-center"><img src="../../../d19m59y37dris4.cloudfront.net/hub/1-4-2/img/person-1.jpg" alt="Han Solo" class="review-image"><span class="text-uppercase text-muted text-small">Dec 2018</span></div>
                ...
                <div class="row review">
                  <div class="col-3 text-center"><img src="../../../d19m59y37dris4.cloudfront.net/hub/1-4-2/img/person-2.jpg" alt="Luke Skywalker" class="review-image"><span class="text-uppercase text-muted text-small">Dec 2018</span></div>
                  <div class="col-9 review-text">
                ...
                <div class="row review">
                  <div class="col-3 text-center"><img src="../../../d19m59y37dris4.cloudfront.net/hub/1-4-2/img/person-3.jpg" alt="Princess Leia" class="review-image"><span class="text-uppercase text-muted text-small">Dec 2018</span></div>
                  <div class="col-9 review-text">
                    <h6>Princess Leia</h6>
                ...
                <div class="row review">
                  <div class="col-3 text-center"><img src="../../../d19m59y37dris4.cloudfront.net/hub/1-4-2/img/person-4.jpg" alt="Jabba Hut" class="review-image"><span class="text-uppercase text-muted text-small">Dec 2018</span></div>
                  <div class="col-9 review-text">
                    <h6>Jabba Hut</h6>
                    <div class="mb-2"><i class="fa fa-star text-primary"></i><i class="fa fa-star text-primary"></i><i class="fa fa-star text-primary"></i><i class="fa fa-star text-primary"></i><i class="fa fa-star text-primary"></i>
                    </div>
        ...
        <div class="row">
          ...
          <div class="item col-lg-3">
            <div class="product is-gray">
              <div class="image d-flex align-items-center justify-content-center"><img src="../../../d19m59y37dris4.cloudfront.net/hub/1-4-2/img/hoodie-woman-1.png" alt="..." class="img-fluid">
          ...
          <div class="item col-lg-3">
            <div class="product is-gray">
              <div class="image d-flex align-items-center justify-content-center"><img src="../../../d19m59y37dris4.cloudfront.net/hub/1-4-2/img/hoodie-woman-2.png" alt="..." class="img-fluid">
                <div class="hover-overlay d-flex align-items-center justify-content-center">
                  <div class="CTA d-flex align-items-center justify-content-center"><a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a><a href="detail.html" class="visit-product active"><i class="icon-search"></i>View</a><a href="#" data-toggle="modal" data-target="#exampleModal" class="quick-view"><i class="fa fa-arrows-alt"></i></a></div>
                </div>
              </div>
          ...
          <div class="item col-lg-3">
            <div class="product is-gray">
              <div class="image d-flex align-items-center justify-content-center"><img src="../../../d19m59y37dris4.cloudfront.net/hub/1-4-2/img/hoodie-woman-3.png" alt="..." class="img-fluid">
                <div class="hover-overlay d-flex align-items-center justify-content-center">
                  <div class="CTA d-flex align-items-center justify-content-center"><a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a><a href="detail.html" class="visit-product active"><i class="icon-search"></i>View</a><a href="#" data-toggle="modal" data-target="#exampleModal" class="quick-view"><i class="fa fa-arrows-alt"></i></a></div>
                </div>
              </div>
          ...
          <div class="item col-lg-3">
            <div class="product is-gray">
              <div class="image d-flex align-items-center justify-content-center"><img src="../../../d19m59y37dris4.cloudfront.net/hub/1-4-2/img/hoodie-woman-4.png" alt="..." class="img-fluid">
                <div class="hover-overlay d-flex align-items-center justify-content-center">
                  <div class="CTA d-flex align-items-center justify-content-center"><a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a><a href="detail.html" class="visit-product active"><i class="icon-search"></i>View</a><a href="#" data-toggle="modal" data-target="#exampleModal" class="quick-view"><i class="fa fa-arrows-alt"></i></a></div>
                </div>
              </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body"> 
            ...
            <div class="row d-flex align-items-center">
              <div class="image col-lg-5"><img src="../../../d19m59y37dris4.cloudfront.net/hub/1-4-2/img/shirt.png" alt="..." class="img-fluid d-block"></div>
