...
<!-- Mirrored from demo.bootstrapious.com/hub/1-4-2/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Feb 2020 19:16:32 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <main class="contact-page">
      ...
      <section>
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-7">
              <form id="contact-form" method="post" action="http://demo.bootstrapious.com/hub/1-4-2/contact.php" class="custom-form form">
                <div class="controls">
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
